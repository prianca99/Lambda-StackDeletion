...
###############################HTml Report Content############################
	...
	response = ses_client.send_email(Source='Prianca.Singh70@T-Mobile.com',Destination={'ToAddresses': ['Prianca.Singh70@T-Mobile.com']},Message={'Subject': {'Data': subject,'Charset': 'UTF-8'},'Body': {'Html': {'Data': report,'Charset': 'UTF-8'}}})
